...
class MiniDecafListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by MiniDecafParser#declStmt.
    def enterDeclStmt(self, ctx:MiniDecafParser.DeclStmtContext):
        pass

    # Exit a parse tree produced by MiniDecafParser#declStmt.
    def exitDeclStmt(self, ctx:MiniDecafParser.DeclStmtContext):
        pass
